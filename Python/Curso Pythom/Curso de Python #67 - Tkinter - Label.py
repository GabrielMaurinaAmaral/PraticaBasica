...
def resetar_test_box():
    resposta = messagebox.askquestion("Resetar", "Resetar mesmo?")
    if resposta == True:
...
frame_1 = Frame(app, borderwidth=1, relief="sunken", background="#423")
frame_1.place(x=10, y=120, width=300, height=100)
...
#Label
label_1=Label(frame_1, text="Gabriel Muairna", background="#423",foreground="#fff", font=("Arial", 15))
